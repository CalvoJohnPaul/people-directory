...
export function Profile({id}: ProfileProps) {
  ...
  const details = {
    ...
    Gender: query.data.gender ? capitalize(query.data.gender.toLowerCase()) : null,
    ...
    'Mobile number': query.data.mobileNumber ? formatMobileNumber(query.data.mobileNumber) : null,
