...
export function PeopleList() {
  ...
  return (
    <div className="grid grid-cols-2 gap-x-3 gap-y-5 lg:grid-cols-[repeat(auto-fill,minmax(150px,1fr))] lg:space-y-0">
      {people.map((person) => (
...
function Person() {
  ...
  return (
    <Link href={`/people/${person.id}`} className="block w-full">
      ...
      <div className="truncate text-neutral-600 text-xs leading-tight">
