...
export const tabsRecipe = tv({
  slots: anatomyToRecipeSlots(tabsAnatomy, {
    list: 'relative flex w-full gap-3 rounded-sm bg-neutral-100/75 p-1.5',
    trigger:
      'relative z-1 block h-11 w-full font-medium text-neutral-600 ui-selected:text-neutral-800',
